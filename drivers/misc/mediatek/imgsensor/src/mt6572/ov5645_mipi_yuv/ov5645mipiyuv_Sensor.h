...
#define OV5645MIPI_IMAGE_SENSOR_VIDEO_WITDH         (1920) 
#define OV5645MIPI_IMAGE_SENSOR_VIDEO_HEIGHT        (1080)

#define OV5645MIPI_IMAGE_SENSOR_1080P_WIDTH          (1920)
#define OV5645MIPI_IMAGE_SENSOR_1080P_HEIGHT         (1080)
